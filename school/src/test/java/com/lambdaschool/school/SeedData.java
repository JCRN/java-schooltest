...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String[] args) throws Exception {
        ...
        Instructor i1 = new Instructor("TEST Sally");
        Instructor i2 = new Instructor("TEST Lucy");
        Instructor i3 = new Instructor("TEST Charlie");
        ...
        Student s1 = new Student("TEST John");
        ...
        Student s2 = new Student("TEST Julian");
        s2.getCourses().add(courseService.findCourseById(c2.getCourseid()));

        Student s3 = new Student("TEST Mary");
